...
### Installing Tapestry
Technically, it's possible to install tapestry using pip in the following way:

```commandline
pip install tapestry
```

However, because of the need for a default config file, we also continue to allow you to download through this repo.
