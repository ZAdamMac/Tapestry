...
global dest; dest = "/home/patches/Desktop/HASH/Tapestry Tests/Control/Corpus" # some pathlike destination to be root
global num; num = 10 #Number of files to include per category
global sizeEach; sizeEach = 10240 # Desired file size in lines (~10k/Gb)
